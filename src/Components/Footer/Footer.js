          ...
          <div className=" px-4 ">
            <div className="mb-10 w-full">
              ...
              <p className="text-body-color mb-7 text-base">
                When developing a web project, I focus on understanding the
                business goals and delivering a final product that will really
                work for the client.
              </p>
              <p className="text-dark flex items-center text-sm font-medium">
                ...
                <span>+880 1638627290</span>
              </p>
            </div>
          </div>
          <div className="px-4 mt-10 md:mt-0">
            <div className="mb-10 w-full">
              ...
              <ul>
                ...
                <li>
                  <a
                    ...
                    className="text-body-colormb-2 inline-block text-base leading-loose"
                  >
                    User Flow
                  </a>
                </li>
